      ...
      <div className="sign">
        <div className="sign-info">
          ...
          <p className="f-lg text-center color-white">
            Part of the admin system to <br/> manage and control the Application.
          </p>
        </div>
        <div className="sign-in-form">
          <div className="sign-in" style={!isForgot && !isSent ? {} : {width: 0, opacity: 0}}>
            <div className="sign-form-title">
              ...
              <br/>
              <span className="color-gray f-xm fw-500">Part of Admin to manage and control.</span>
            </div>          
              ...
              {isErrorSignIn === false?
                    ...
                    <>
                       <div className="col-12 d-flex jc-center pb-2">
                          <label className="f-sm color-5 text-center" htmlFor="error">The email address you entered isn't connected to admin or password not correct.</label>
                      </div>
                    </>
              } 
          ...
          <div className="forgot-password" style={isForgot && !isSent ? {} : {width: 0, opacity: 0}}>
            ...
            <form onSubmit={handleSubmitForgetEmail}>
              ...
              <a className="color-black f-md d-flex jc-center ai-center pt-4" href="/Admin#" onClick={() => setIsForgot(false)}>
